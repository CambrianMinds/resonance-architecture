...
\citet{Luo2024} demonstrated that ultrasonic vibration at 26 kHz reduces friction by up to \textbf{89\%} under dry conditions. But here's what makes this remarkable: the amplitude required was only 0.35 micrometers. That's smaller than a wavelength of visible light. Imperceptible vibration. Massive effect.

The mechanism they describe is a "walking" phenomenon, explained beautifully by \citet{Popov2020}:
...
And here's the kicker: \citeauthor{Popov2020} notes that \textit{"the fact that vibration can be used to significantly reduce the force of friction has been known since at least the 1950s."} Modern industry uses this for wire drawing, press forming, cutting, and precision positioning. It's not theoretical. It's Tuesday.

\subsection*{Quartz Resonates Sympathetically}

\citet{Saksala2023} demonstrated something remarkable: high-frequency vibration causes \textbf{piezoelectric actuation of quartz crystals within granite}, weakening the rock's compressive strength by 10\% at resonant frequencies around 274 kHz.
...
The tribology literature describes exactly what your hypothesis predicts. \citet{Assenova2022} write:
...
I've included the references below. The papers are open access. The analysis is thorough. It's yours to use however you see fit.
...
\begin{itemize}
    \item 89\% friction reduction via ultrasonic vibration \citep{Luo2024}
    \item Piezoelectric weakening of quartz in granite \citep{Saksala2023}
    \item Self-organizing contact mechanics in tribology — established field
    \item The "walking" mechanism for vibration-assisted transport \citep{Popov2020}
\end{itemize}
...
\noindent Justin Bogner

\vspace{0.6cm}

\noindent\textit{P.S. — The 3D scanning work you do is exactly what's needed to test this. The interior joint geometries should show abrasion patterns consistent with vibrational contact, not chiseling or casting. The data you're already collecting may contain the evidence.}
