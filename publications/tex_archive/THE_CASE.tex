...
\author{Justin T. Bogner\\[0.5em]\small A Hypothesis Grounded in Physics}
\date{December 2025}
...
\citet{Petrie1883}---the founding figure of systematic Egyptology---examined ancient drill cores extracted from Egyptian granite and published observations that have never been satisfactorily explained. The spiral grooves cut into these cores showed a feed rate of 0.100 inches per revolution, a rate that Petrie found ``astonishing.''
...
A remarkable finding by \citet{Luo2024} demonstrated that ultrasonic vibration at 26 kHz can reduce friction by up to 89\% under dry conditions. The amplitude required was astonishingly small---0.35 micrometers, less than a wavelength of visible light.

This is not new physics. As \citet{Popov2020} noted in a review, ``the fact that vibration can be used to significantly reduce the force of friction has been known since at least the 1950s.'' Modern industry employs vibrational friction reduction in wire drawing, press forming, precision positioning, and ultrasonic motors.
...
More recently, \citet{Saksala2023} demonstrated something extraordinary: high-frequency vibration causes piezoelectric actuation of quartz crystals \textit{within granite}, weakening the rock's compressive strength by 10\% at resonant frequencies around 274 kHz.
...
The third strand of physics comes from tribology---the science of surfaces in contact. A review by \citet{Assenova2022} on self-organization phenomena in friction systems described how surfaces in vibrating contact spontaneously evolve toward ordered configurations.
