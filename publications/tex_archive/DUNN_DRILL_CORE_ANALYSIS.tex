...
Petrie documented his observations in his 1883 book, \textit{The Pyramids and Temples of Gizeh} \citep{Petrie1883}, which is still available in digitized form from the Giza Archives at Harvard. His language is careful, his measurements precise, his conclusions understated. But the implications are extraordinary.
...
Research by \citet{Saksala2023} illuminates the Petrie paradox from an unexpected direction.

The paper examined what happens when you subject granite to high-frequency alternating current. The title is technical: ``Weakening of Compressive Strength of Granite by Piezoelectric Actuation of Quartz Using High-Frequency and High-Voltage Alternating Current.''
